...
class OutsourcingWorkOrderProductionScheduleListByArea extends Component {
  constructor(props) {
    super(props);
...
export default OutsourcingWorkOrderProductionScheduleListByArea;
