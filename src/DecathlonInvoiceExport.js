...
const DecathlonInvoiceExport = (props) => {
  /** redux **/
          ...
          <Grid container spacing={1} alignItems="center" justify="center">
            ...
            <Grid item xs={12} md={2}>
              ...
              <Collapse in={open}>
                ...
                >
                  <Wait on="excel wait" fallback={<Spinner text="處理中" />} ><AlertTitle>{downloadExcelUrl}</AlertTitle></Wait>
                </Alert>
              </Collapse>
            ...
            <Grid item xs={12} md={2}>
              ...
              <Collapse in={pdfOpen}>
                ...
                >
                  <Wait on="pdf wait" fallback={<Spinner text="處理中" />}><AlertTitle>{downloadPdfUrl}</AlertTitle></Wait>
...
export default DecathlonInvoiceExport;
